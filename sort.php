...
$sql = $wpdb->prepare('INSERT INTO  wp_cma46_art_website (website_code, website_type)
SELECT  website_code, website_type
FROM wp_cma46_artisantemp
WHERE NOT EXISTS (SELECT  website_code, website_type
FROM wp_cma46_artisantemp)
GROUP BY website_code, website_type');
...
// need to use the export i made from the previous table
